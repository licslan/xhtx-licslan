...
public class ReturnFormat {
    ...
    //初始化状态码与文字说明
    static {
        messageMap.put("0",   "success your everything is ok!");
        messageMap.put("-1",  "fail your operating was failed");
    ...
    public static String retParam(int status,Object data) {
        OutputJson json = new OutputJson(status,
                messageMap.get(String.valueOf(status)), data);
